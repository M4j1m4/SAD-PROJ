    ...
    <body>
        ...
        <div class="content-container">
            <div class="container my-5">
                <a class="btn btn-primary" href="/SAISystem/create.php" role="button">New Account</a>
                <br>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        while($row = $result->fetch_assoc()){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class='btn btn-primary btn-sm' href='/SAISystem/edit.php?id=$row[id]'>EDIT</a>
                                    <a class='btn btn-danger btn-sm' href='/SAISystem/delete.php?id=$row[id]'>DELETE</a>
                                </td>
                            </tr>
                            ";
                        }
